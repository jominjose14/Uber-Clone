...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void callUber(View view) {
        ...
        if(!requestActive && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
        ...
        } else if(requestActive){ //Cancel all pending requests
